...
export default function UnassignedInspector({
  ...
  const amountFormatted =
    typeof record.amount_minor === 'number' && record.currency
      ? new Intl.NumberFormat('en-IN', { style: 'currency', currency: record.currency }).format(
        ...
        <div className="flex-1 space-y-6">
          ...
          <div>
            ...
            <div className="bg-white rounded-xl border border-[#064E3B]/10 overflow-hidden text-[13px]">
              ...
              <div className="grid grid-cols-[120px_1fr] border-b border-[#064E3B]/5">
                <div className="px-4 py-3 bg-[#064E3B]/5 font-medium text-[#064E3B]/70">
                  Merchant
                </div>
                <div className="px-4 py-3 text-[#064E3B]">
                  {record.merchant_raw || (
                    <span className="text-[#064E3B]/40 italic">Not found</span>
                  )}
                </div>
              </div>
              {record.source_message_id && (
                <div className="grid grid-cols-[120px_1fr] border-b border-[#064E3B]/5">
                  ...
                  <div
                    className="px-4 py-3 text-[#064E3B]/70 font-mono text-[11px] truncate"
                    title={record.source_message_id}
                  >
                    {record.source_message_id}
                  </div>
                </div>
              ...
              {(emailHtml || emailText) && (
                <div className="grid grid-cols-[120px_1fr]">
                  <div className="px-4 py-3 bg-[#064E3B]/5 font-medium text-[#064E3B]/70 border-t border-[#064E3B]/5">
                    Source Mail
                  </div>
