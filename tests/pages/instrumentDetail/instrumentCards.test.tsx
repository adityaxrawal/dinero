...
import EditableDetailsCard from '@/pages/instrumentDetail/EditableDetailsCard';
import SavedPasswordsCard from '@/pages/instrumentDetail/SavedPasswordsCard';
import RecentTransactionsCard from '@/pages/instrumentDetail/RecentTransactionsCard';
import StatementHistoryCard from '@/pages/instrumentDetail/StatementHistoryCard';
