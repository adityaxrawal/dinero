...
import TransactionHero from '@/pages/transactionDetail/TransactionHero';
import DetailActions from '@/pages/transactionDetail/DetailActions';
import RawSourceDialog from '@/pages/transactionDetail/RawSourceDialog';
